...
let g:IngoLibrary_ConfirmChoices = [g:testdir . '/testdata/001/dev/sub/lala.txt',  g:outsideDir . '/lala.txt']
...
call vimtap#file#Is(FilePathConvert#ToLocal('//stagesrv001.local/subaccess/lala.txt'), g:outsideDir . '/lala.txt', 'UNC to queried absolute #2')
